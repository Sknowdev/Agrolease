...
| 2 | Auth + Profile ID | 🟡 In Progress | 2026-07-17 | Brief: `Task-02-Auth-ProfileID.md` (v5). Role Selection removed per Amendment 7. Home + My Conduits built as real zero-states per Amendment 8 (not a generic "Dashboard stub"). Conduit Workspace explicitly excluded — nothing to open until Task 3. Building on new branch `feature/task2-auth-profile-id`, off current `main` (which already includes Task 1's merged code). |
