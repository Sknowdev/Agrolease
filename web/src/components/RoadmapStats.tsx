...
export function RoadmapStats() {
  ...
  return (
    <section aria-labelledby="roadmap-heading" className="w-full py-20 sm:py-28">
      <div className="mx-auto max-w-5xl px-4 sm:px-8">
        <ScrollReveal>
          <div className="glow-border rounded-2xl bg-surface p-8 sm:p-12">
             ...
             * countries backed by an automated scraper today," which is
             * exactly the kind of implementation detail a visitor doesn't
             * care about and reads as an odd thing to boast about. Removed
             * per feedback.
             */}
